 ...
 *
 * source : http://benchmarksgame.alioth.debian.org/u64q/program.php?test=nbody&lang=gpp&id=1
 */
...
namespace
{
    ...
    tuple<H, T...> construct_tuple(H h, T... a)
    {
    ...
    const Sdouble pi = 3.141592653589793;
    const Sdouble solar_mass = 4 * pi * pi;
    const Sdouble days_per_year = 365.24;
    const Sdouble dt = 0.01;
        ...
        struct
        {
            ...
            struct foreach_block
            {
                ...
                void operator()(T2 &b2)
                {
                    ...
                    Sdouble dy = b.y - b2.y;
                    Sdouble dz = b.z - b2.z;
                    Sdouble distance = sqrt(dx * dx + dy * dy + dz * dz);
                    Sdouble mag = dt / (distance * distance * distance);
                    b.vx -= dx * b2.mass * mag;
                    b.vy -= dy * b2.mass * mag;
                    b.vz -= dz * b2.mass * mag;
                    b2.vx += dx * b.mass * mag;
...
int main(int argc,char** argv)
{
    ...
    std::cout << energy(solar_system) << std::endl;
